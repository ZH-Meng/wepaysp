	...
	<div class="rightbg">
		...
		<div class="bgtj">
			<div class="clear juese_m">
				<div class="header-1">角色名称：<s:property value="roleName" escape="false" /></div>
				<div class="block">
			...
			<s:form method="post">
				<s:if test="roleNames == '全部'">
					<input type="hidden" name="roleName" value="" />
				</s:if>
				<s:else>
					<input type="hidden" name="roleName" value="${roleNames}" />
				</s:else>
				<input type="hidden" name="roleLevel" value="${roleLevel}" />
