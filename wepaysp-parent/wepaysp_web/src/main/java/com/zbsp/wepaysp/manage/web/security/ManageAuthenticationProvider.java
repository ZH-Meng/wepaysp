    ...
    protected UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication)
        ...
        try {
            ...
            loadedUser = new ManageUser(sysUser.getIwoid(), sysUser.getUserId(), sysUser.getUserName(), sysUser.getLoginPwd(), null, sysUser.getUserLevel(),
                sysUser.getDataPermisionType(), sysUser.getPartner(), sysUser.getDealer(), sysUser.getPartnerEmployee(), sysUser.getDealerEmployee(), sysUser.getSchool(), sysUser.getLastLoginIp(), sysUser.getLastLoginTime(), roleIndex, true, true, true, true, auths);
