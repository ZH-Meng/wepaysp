package com.zbsp.wepaysp.common.http.httpclient.builder;
...
import com.zbsp.wepaysp.common.http.common.SSLs;
...
public class HCB extends HttpClientBuilder {
    ...
    public HCB ssl()
        ...
        Registry<ConnectionSocketFactory> socketFactoryRegistry = RegistryBuilder.<ConnectionSocketFactory> create()
            .register("http", PlainConnectionSocketFactory.INSTANCE).register("https", ssls.getSSLCONNSF()).build();
        // 设置连接池大小
